...
![Diagrama de puntos (dotplot)](01-imagenes/media-balanza.svg){#fig-media}

![Palanca de primer grado](01-imagenes/palanca.png){#fig-palanca}
...
[Normalmente la respuesta al problema *verde* se sitúa en la misma página, en el margen anexo al recuadro]{.aside}

::: {.content-visible .callout-note when-format="html" icon="false"}
## Problema o cuestión a resolver
...
![Visicalc, primera hoja de cálculo para el ordenador *Apple II* (1979)](01-imagenes/280px-Visicalc.png){.column-margin}
...
![Hoja de cálculo Lotus 1-2-3 para MS-DOS (1983)](01-imagenes/Lotus-123-3.0-MSDOS.png){.column-margin}
...
![Logotipo de R (2023)](01-imagenes/Rlogo.svg){.column-margin}
