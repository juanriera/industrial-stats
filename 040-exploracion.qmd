...
Modificando el criterio de la amplitud de clase podemos cambiar la tabla, igual que hemos hecho en Excel. Por ejemplo, cambiamos la opcion de agrupación en `mutate`indicando que los intervalos sean de amplitud 2 en vez de 1: `breaks = seq(40, 54, by =2)`. 
