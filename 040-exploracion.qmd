...
4. **Completar los intervalos faltantes**
...
5. **Calcular la frecuencia absoluta**:
   ```r
...
Para visualizar las variables continuas se utiliza el **histograma**, que es un diagrama que utiliza las barras rectangulares para hacer un gráfico de la distribución de valores continuos, previamente agrupados en intervalos (_bins_ en inglés), tal como se ha hecho en la tabla de frecuencias.
...
### Construcción de un histograma en Excel (ejemplo de la altura en cm. de un  grupo de alumnos)

Podemos utilizar dos métodos para hacer un histograma en Excel

#### Método 1: histograma directo
Simplemente, seleccionar el rango de datos e insertar el gráfico, seleccionando `Histograma`en el icono `Seleccionar gráficos de estadística`

![](01-imagenes/excel-histo-aula1.png){fig-align="center" width=50%}

Excel calcula automáticamente la amplitud de los intervalos y el número de columnas; estas opciones pueden modificarse seleccionando el eje X del gráfico con el botón derecho del ratón, y después seleccionando `Dar formato al eje`. La descripción de los intervalos utiliz los mismos símbolos que hemos visto en las tablas de frecuencias de R.
...
#### Método2: utilizar una tabla dinámica
