...
Cálculo de la media aritmética sin usar la estadística.

Centro de gravedad, propiedades de la media, distancia a los valores.
diferencias entre media y mediana: influencia de los valores en la media, posición en la mediana.

ver si poner distribuciones de frecuencia antes de explicar los cinco numeros

Volviendo a nuestro ejemplo de las alturas de los alumnos, supongamos que en nuestro grupo de once personas no hubiese variación: que todos ellos tuviesen la misma altura. Si fuese así, podemos encontrar un valor $x$ de altura que, repetido once veces, sea equivalente a la suma de las alturas de todos ellos. Si representamos cada alumno con una letra, la suma de sus alturas sería: 
