...
Supongamos que queremos medir la altura de los alumnos de nuestra clase. Éste es nuestro grupo de estudiantes:

![](01-imagenes/grupo1.jpg)

Realizamos las medidas y registramos la altura de cada persona en una hoja de cálculo, siguiendo las buenas prácticas que hemos visto al estudiar los *datos ordenados*.

Exploramos los datos con el histograma y el boxplot
